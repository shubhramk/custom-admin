...
@Component({
  selector: 'app-general-answer-edit',
  templateUrl: './general-answer-edit.component.html',
  styleUrls: ['./general-answer-edit.component.css']
})
export class GeneralAnswerEditComponent implements OnInit {
...
cancelBtnHandler(){
  this.navigateTo('sh8ke/generalAnswer/'+GlobalVariableConfig.ANSWER_ID+"/"+GlobalVariableConfig.QUESTION_ID);
