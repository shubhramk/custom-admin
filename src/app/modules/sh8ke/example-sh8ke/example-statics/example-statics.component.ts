...
@Component({
  selector: 'app-example-statics',
  templateUrl: './example-statics.component.html',
  styleUrls: ['./example-statics.component.css']
})
export class ExampleStaticsComponent implements OnInit {
  monthlyReport = [];
